...
HD_PWD='C:/Users/Daniel/Documents/ProgH-Practica/Practicum06/Practicum06.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bouncecube.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bouncecube.tcl
