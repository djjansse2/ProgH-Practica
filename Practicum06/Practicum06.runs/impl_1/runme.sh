...
HD_PWD='C:/Users/Daniel/Documents/ProgH-Practica/Practicum06/Practicum06.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bouncecube.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bouncecube.tcl -notrace
