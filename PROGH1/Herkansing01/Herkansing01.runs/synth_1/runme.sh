...
HD_PWD='C:/Users/djans/Documents/ProgH-Practica/Herkansing01/Herkansing01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SnakeController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SnakeController.tcl
