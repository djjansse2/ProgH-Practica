...
HD_PWD='C:/Users/djans/Documents/ProgH-Practica/Herkansing01/Herkansing01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SnakeController.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SnakeController.tcl -notrace
