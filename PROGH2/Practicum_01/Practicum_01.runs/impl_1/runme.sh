...
HD_PWD='C:/Users/Daniel/Documents/ProgH-Practica/PROGH2/Practicum_01/Practicum_01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AudioGen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AudioGen.tcl -notrace
