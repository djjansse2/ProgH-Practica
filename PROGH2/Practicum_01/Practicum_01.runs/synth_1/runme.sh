...
HD_PWD='C:/Users/Daniel/Documents/ProgH-Practica/PROGH2/Practicum_01/Practicum_01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AudioGen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AudioGen.tcl
