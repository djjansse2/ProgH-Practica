...
HD_PWD='D:/FPGA/ProgH-Practicum/PROGH2/EindopdrachtMicroblaze/EindopdrachtMicroblaze.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NoteviewTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NoteviewTop.tcl
