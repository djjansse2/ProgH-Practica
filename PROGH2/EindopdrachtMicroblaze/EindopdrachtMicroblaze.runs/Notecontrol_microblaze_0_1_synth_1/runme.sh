...
HD_PWD='D:/FPGA/ProgH-Practicum/PROGH2/EindopdrachtMicroblaze/EindopdrachtMicroblaze.runs/Notecontrol_microblaze_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Notecontrol_microblaze_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Notecontrol_microblaze_0_1.tcl
