...
HD_PWD='D:/FPGA/ProgH-Practicum/PROGH2/EindopdrachtMicroblaze/EindopdrachtMicroblaze.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NoteviewTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NoteviewTop.tcl -notrace
