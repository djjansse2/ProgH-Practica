...
HD_PWD='D:/FPGA/ProgH-Practicum/PROGH2/EindopdrachtMicroblaze/EindopdrachtMicroblaze.runs/Notecontrol_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Notecontrol_axi_uartlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Notecontrol_axi_uartlite_0_0.tcl
