...
synth_design -top Pixel_Clock -part xc7a35tcpg236-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix Pixel_Clock_ Pixel_Clock.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ Pixel_Clock_stub.v
 lappend ipCachedFiles Pixel_Clock_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ Pixel_Clock_stub.vhdl
 lappend ipCachedFiles Pixel_Clock_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ Pixel_Clock_sim_netlist.v
 lappend ipCachedFiles Pixel_Clock_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ Pixel_Clock_sim_netlist.vhdl
 lappend ipCachedFiles Pixel_Clock_sim_netlist.vhdl

 config_ip_cache -add -dcp Pixel_Clock.dcp -move_files $ipCachedFiles -use_project_ipc -ip [get_ips Pixel_Clock]
}

rename_ref -prefix_all Pixel_Clock_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef Pixel_Clock.dcp
