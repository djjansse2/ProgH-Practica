...
HD_PWD='C:/Users/Daniel/Documents/ProgH-Practica/PROGH2/Eindopdracht/EindOpdracht/EindOpdracht.runs/Pixel_Clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pixel_Clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pixel_Clock.tcl
