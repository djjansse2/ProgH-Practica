...
HD_PWD='C:/Users/Daniel/Documents/ProgH-Practica/PROGH2/Eindopdracht/EindOpdracht/EindOpdracht.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MainGame.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MainGame.tcl -notrace
