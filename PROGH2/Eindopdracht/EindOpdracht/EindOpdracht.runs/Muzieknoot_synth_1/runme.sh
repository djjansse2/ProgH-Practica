...
HD_PWD='C:/Users/Daniel/Documents/ProgH-Practica/PROGH2/Eindopdracht/EindOpdracht/EindOpdracht.runs/Muzieknoot_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Muzieknoot.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Muzieknoot.tcl
