...
HD_PWD='C:/Users/Daniel/Documents/ProgH-Practica/Practicum03-ALU/Practicum03-ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALUOnBoard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALUOnBoard.tcl
