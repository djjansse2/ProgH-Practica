...
HD_PWD='C:/Users/Daniel/Documents/ProgH-Practica/Practicum03-ALU/Practicum03-ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALUOnBoard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALUOnBoard.tcl -notrace
