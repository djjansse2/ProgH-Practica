...
HD_PWD='C:/Users/Daniel/Documents/ProgH-Practica/Stopwatch/Stopwatch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Watch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Watch.tcl
